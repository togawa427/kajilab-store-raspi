...
type TotalWithdrawalPanelProps = {
  ...
  setScanedBarcode: any;
}

const TotalWithdrawalPanel = ({totalWithdrawal, setTotalWithDrawal, setScanedBarcode}: TotalWithdrawalPanelProps) => {
  return (
